...
public class AdjacencyList {
     ...
     * @param intervalList is a list of intervals forming the interval graph - List&lt;Interval&gt;
     */
     ...
     * @return list of intervals that overlap the named interval - List<Interval>
